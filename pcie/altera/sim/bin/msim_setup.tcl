...
alias com {
  ...
  vlog -sv                                                              "$QSYS_SIMDIR/mkPcieS5Top_tb/simulation/submodules/altera_avalon_clock_source.sv"                            -L altera_common_sv_packages -work mkPcieS5Top_inst_clk_50_bfm    
  vlog                                                                  "$QSYS_SIMDIR/mkPcieS5Top_tb/simulation/submodules/altera_pcie_sv_hip_ast.v"                                                                         -work APPS 
  vlog                                                                  "$QSYS_SIMDIR/mkPcieS5Top_tb/simulation/submodules/altera_pcie_reconfig_driver.v"                                                                         -work APPS 
