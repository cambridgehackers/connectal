...
[Makefile.xbsv](../Makefile.xbsv) and define some `make`
variables.
...
Designs outside the xbsv directory using `xbsv` may also include `Makefile.xbsv`:
...
---------------------------------
    ...
    BSVFILES = ...
    CPPFILES = ...
    include /scratch/xbsv/Makefile.xbsv
---------------------------------
