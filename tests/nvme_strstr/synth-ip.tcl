...
if {$partname != {xc7vx690tffg1761-2}} {
    ...
    fpgamake_ipcore axi_pcie3 2.1 axi_pcie_rp [list CONFIG.mode_selection {Advanced} CONFIG.device_port_type {Root_Port_of_PCI_Express_Root_Complex} CONFIG.pcie_blk_locn {X0Y0} CONFIG.pl_link_cap_max_link_speed {5.0_GT/s} CONFIG.SYS_RST_N_BOARD_INTERFACE {Custom} CONFIG.PCIE_BOARD_INTERFACE {Custom} CONFIG.pl_link_cap_max_link_width {X8} CONFIG.axi_data_width {128_bit} CONFIG.plltype {CPLL} CONFIG.axisten_freq {250} CONFIG.dedicate_perst {false} CONFIG.pf0_device_id {7131} CONFIG.pf0_base_class_menu {Bridge_device} CONFIG.pf0_class_code_base {06} CONFIG.pf0_sub_class_interface_menu {CardBus_bridge} CONFIG.pf0_class_code_sub {07} CONFIG.pf0_class_code {060700} CONFIG.pf0_bar0_size {2} CONFIG.pf0_bar0_scale {Gigabytes} CONFIG.axibar_highaddr_0 {0xffffffffffffffff} ]
}
