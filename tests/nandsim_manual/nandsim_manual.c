...
int main(int argc, const char **argv)
{
  ...
  init_portal_internal(&intarr[0], IfcNames_DmaIndication, DmaIndicationWrapper_handleMessage, NULL, DmaIndicationWrapper_reqsize);     // fpga1
  init_portal_internal(&intarr[1], IfcNames_NandSimIndication, NandSimIndicationWrapper_handleMessage, NULL, NandSimIndicationWrapper_reqsize); // fpga2
  init_portal_internal(&intarr[2], IfcNames_DmaConfig, NULL, NULL, DmaConfigProxy_reqsize);         // fpga3
