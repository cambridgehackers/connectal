...
To generate code for Zedboard:
    ./genxpsprojfrombsv -B zedboard -p hdmiproj -x HDMI XADC -b HdmiDisplay bsv/HdmiDisplay.bsv bsv/PortalMemory.bsv

To generate code for a ZC702 board:
    ./genxpsprojfrombsv -B zc702 -p hdmiproj -x HDMI XADC -b HdmiDisplay bsv/HdmiDisplay.bsv bsv/PortalMemory.bsv
...
To generate code for a ZC702 board:
    ./genxpsprojfrombsv  -B zc702 -p fooproj -x HDMI ImageonVita -b ImageCapture examples/imageon/ImageCapture.bsv bsv/BlueScope.bsv bsv/PortalMemory.bsv bsv/AxiSDMA.bsv
