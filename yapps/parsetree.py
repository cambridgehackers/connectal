...
class Generator:
    ...
    def generate_output(self):
        ...
        self.write("        newrt.Scanner.__init__(self,None,%s,str)\n" %
                   repr(self.ignore))
        self.write("\n")
        
        self.write("class ", self.name, "(newrt.Parser):\n")
        self.write(INDENT, "Context = newrt.Context\n")
        for r in self.goals:
        ...
        self.write("    return newrt.wrap_error_reporter(P, rule)\n")
        self.write("\n")
...
class Choice(Node):
    ...
    def output(self, gen, indent):
        ...
        if tokens_unseen:
            gen.write(indent, "else:\n")
            gen.write(indent, INDENT, "raise newrt.SyntaxError(_token[0], ")
...
class Star(Wrapper):
    ...
    def output(self, gen, indent):
        ...
        gen.write(indent+INDENT, "raise newrt.SyntaxError(charpos=self._scanner.get_prev_char_pos(), context=_context, msg='Need one of ' + ', '.join(%s))\n" %
                  repr(self.first))
