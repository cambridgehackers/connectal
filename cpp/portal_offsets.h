...
#else
unsigned int read_portal_bsim(struct portal *p, volatile unsigned int *addr, char *name);
void write_portal_bsim(struct portal *p, volatile unsigned int *addr, unsigned int v, char *name);
