...
set_property PACKAGE_PIN "E15" [get_ports "GPIO_leds[0]"]
...
set_property PACKAGE_PIN "D15" [get_ports "GPIO_leds[1]"]
...
set_property PACKAGE_PIN "W17" [get_ports "GPIO_leds[2]"]
...
set_property PACKAGE_PIN "W5" [get_ports "GPIO_leds[3]"]
set_property slew "SLOW" [get_ports "GPIO_leds[3]"]
set_property PIO_DIRECTION "OUTPUT" [get_ports "GPIO_leds[3]"]

set_property iostandard "LVCMOS25" [get_ports "GPIO_leds[4]"]
set_property PACKAGE_PIN "V7" [get_ports "GPIO_leds[4]"]
set_property slew "SLOW" [get_ports "GPIO_leds[4]"]
set_property PIO_DIRECTION "OUTPUT" [get_ports "GPIO_leds[4]"]

set_property iostandard "LVCMOS25" [get_ports "GPIO_leds[5]"]
set_property PACKAGE_PIN "W10" [get_ports "GPIO_leds[5]"]
set_property slew "SLOW" [get_ports "GPIO_leds[5]"]
set_property PIO_DIRECTION "OUTPUT" [get_ports "GPIO_leds[5]"]

set_property iostandard "LVCMOS25" [get_ports "GPIO_leds[6]"]
set_property PACKAGE_PIN "P18" [get_ports "GPIO_leds[6]"]
set_property slew "SLOW" [get_ports "GPIO_leds[6]"]
set_property PIO_DIRECTION "OUTPUT" [get_ports "GPIO_leds[6]"]

set_property iostandard "LVCMOS25" [get_ports "GPIO_leds[7]"]
set_property PACKAGE_PIN "P17" [get_ports "GPIO_leds[7]"]
...
set_property PACKAGE_PIN "L16" [get_ports "CLK_hdmi_clock_if"]
...
set_property PACKAGE_PIN "D13" [get_ports "I2C0_scl"]
...
set_property PACKAGE_PIN "C10" [get_ports "I2C0_sda"]
