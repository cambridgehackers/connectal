...
set_property PACKAGE_PIN "W18" [get_ports "CLK_hdmi_clock_if"]
...
set_property PACKAGE_PIN "H15" [get_ports "XADC_gpio[0]"]
...
set_property PACKAGE_PIN "R15" [get_ports "XADC_gpio[1]"]
...
set_property PACKAGE_PIN "K15" [get_ports "XADC_gpio[2]"]
